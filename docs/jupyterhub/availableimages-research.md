...
|:----------------------|:--------------------|:---------------------|:--------------------------------|
| Stack Minimal         | [minimal-notebook](https://gitlab.nrp-nautilus.io/prp/jupyter-stack/-/tree/prp/minimal-notebook){:target="_blank"} | Ubuntu 20.04<br/>JupyterLab 4.0.2<br/>Python 3.10.12<br/>Git 2.25.1<br/>Cuda 11.7.r11.7<br/>vi<br/>nano<br/>tzdata<br/>unzip | SDSU, CSU TIDE |
